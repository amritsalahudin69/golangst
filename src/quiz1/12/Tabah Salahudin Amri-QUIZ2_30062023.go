...
//cek dipake apa engga
/*
func NewGameList(NewArticleId int, NewAuthor Author, NewImage string, NewImageDesktop string, NewImageHighlight string, NewPublishedDate time.Time, NewTranslation Translation) *Gamelist  {
	return &Gamelist{
		ArticleId : NewArticleId,
		Author: NewAuthor,
		Image: NewImage,
		ImageDesktop: NewImageDesktop,
		ImageHighlight : NewImageHighlight,
...
func (GL *Gamelist) GetArticleId() int {
	return GL.ArticleId
}
func (GL *Gamelist) GetAuthor () Author {
	return GL.Author
}
func (GL *Gamelist) GetImage () string  {
	return GL.Image
}
func (GL *Gamelist) GetImageDesktop ()  string{
	return GL.ImageDesktop
}
func (GL *Gamelist) GetImageHighlight () string  {
	return GL.ImageHighlight
}
func (GL *Gamelist) GetPublishedDate () time.Time  {
	return GL.PublishedDate
}
func (GL *Gamelist) GetTranslation () Translation {
	return GL.Translation
}
type Author struct {
...
func (a *Author)  GetProfilePicture() string {
...
func (G *Game) GetIdGame () int  {
	return G.Id
}
func (G *Game) GetNameGame () string {
	return G.Name
}
type Translation struct {
	...
	ArticleId int `json:"articleId"`
	RatingComment int `json:"ratingComment"`
	Meta          Meta
}
type Genre struct {
	IdGenre int `json:"id"`
...
func (ge *Genre) GetIdGenre() int  {
	return ge.IdGenre
}
func (ge *Genre) GetGName () string  {
	return ge.GName
}
func (ge *Genre) GetIsHighlight () bool  {
	return ge.IsHighlight
}
type Platform struct {
	Id int `json:"id"`
	PName string`json:"name"`
	PIsHighlight bool `json:"isHighlight"`
	Logo string `json:"logo"`
	Image string `json:"image"`
}
func (p *Platform) GetIdPlatform () int  {
	return p.Id
}
func (p *Platform) GetNamePlatform () string  {
	return p.PName
}
